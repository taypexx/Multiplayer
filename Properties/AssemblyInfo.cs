...
using MelonLoader;
using Main = Multiplayer.Main;

[assembly: MelonInfo(typeof(Main), Main.Name, Main.Version, "taypexx & 7OU")]
...
[assembly: AssemblyVersion(Main.Version + ".0")]
[assembly: AssemblyFileVersion(Main.Version + ".0")]